...
```bash
git clone git@github.com:nhnad-haru/team-ai-workflow.git ~/workspace/team-ai-workflow
...
```bash
bash ~/workspace/team-ai-workflow/scripts/install-skills.sh
```
...
```bash
cd my-project
bash ~/workspace/team-ai-workflow/scripts/init-project.sh
```
