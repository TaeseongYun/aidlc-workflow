...
**Reference-knowledge skills** that expand `guidance.md` (the team Flutter baseline) into 7 topics. Each skill
...
6 skills are the deep architecture/quality/codegen rules alongside this guard — Figma-generated widgets are routed back through flutter-security before merge.
