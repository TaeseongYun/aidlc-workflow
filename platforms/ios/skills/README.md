...
**Reference-knowledge skills** that expand `guidance.md` (the team iOS baseline) into 6 topics. Each skill
...
| [ios-module-structure](ios-module-structure/SKILL.md) | Thin app target + SPM packages · Interface/Live split timing · composition-root DI (no framework) | `**/Package.swift`, `**/Packages/**/*.swift`, `**/App/**/*.swift`, `**/*App.swift` |
...
The other 5 skills are the deep architecture/quality rules this guard references.
