...
**Reference-knowledge skills** that expand `guidance.md` (the team RN baseline) into 6 topics. Each skill
...
| [rn-performance-ux](rn-performance-ux/SKILL.md) | `FlatList`/`FlashList` + stable keys · Reanimated worklets · one styling system · **accessibility safety guard** (roles/labels, ≥44pt) | `**/*.tsx`, `**/components/**/*.tsx`, `**/*List*.tsx`, `**/theme/**` |
...
The other 4 skills are the architecture/data/native/navigation rules these guards reference.
